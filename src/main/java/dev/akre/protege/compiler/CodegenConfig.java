...
public interface CodegenConfig {
     ...
     *
     * @param descriptor The descriptor to check options for.
     ...
     *
     * @return A list of AnnotationSpec for fields.
     */
     ...
     *
     * @return A list of AnnotationSpec for the class.
     */
     ...
     *
     * @return A list of AnnotationSpec for the interface.
     */
     ...
     *
     * @return A list of AnnotationSpec for the builder.
     */
     ...
     * @return The DescriptorProto for the named message.
     */
     ...
     *
     * @param descriptor The descriptor to check options for.
     * @return True if the Case enum should be generated.
     */
     ...
     *
     * @return An Optional containing the interface name, or empty if none.
     */
     ...
     *
     * @return The outer class name, or empty string if not defined.
     */
     ...
     * @return True if the field represents a map.
     */
     ...
     *
     * @return A map of type names to ClassName objects.
     */
    ...
    /**
     * Configuration specialized for Message generation.
     */
