...
public interface CodegenConfig {
     ...
     *
     * @return The underlying {@link CodegenMetadata}.
     */
     ...
     * @return {@code true} if the deprecated annotation should be generated.
     */
     ...
     *
     * @param descriptor The descriptor to check.
     * @return {@code true} if enhanced oneof generation is enabled.
     */
     ...
     *
     * @param descriptor The descriptor to check.
     * @return {@code true} if the legacy case enum should be generated.
     */
     ...
     *
     * @return An optional string containing the interface name.
     */
     ...
     *
     * @return The class name of the message superclass.
     */
     ...
     * @return The resolved JavaPoet {@link TypeName}.
     */
     ...
     *
     * @param protoTypeName The protobuf type name.
     * @param currentScope The current scope as a {@link Cons} list.
     * @return The resolved JavaPoet {@link TypeName}.
     */
     ...
     * @return The resolved JavaPoet {@link TypeName} for the field.
     */
     ...
     *
     * @param field The field descriptor.
     * @return {@code true} if the field is a map field.
     */
     ...
     *
     * @return The {@link ClassName} of the field accessor table.
     */
     ...
     *
     * @return A map of type names to their corresponding {@link ClassName}.
     */
    ...
    /**
     * Configuration specific to message generation.
     */
