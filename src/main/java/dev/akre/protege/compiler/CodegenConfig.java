...
public interface CodegenConfig {
     ...
     *
     * @return A list of {@link AnnotationSpec} to be applied to the generated builder.
     */
     ...
     * @return {@code true} if enhanced oneof is enabled, {@code false} otherwise.
     */
     ...
     *
     * @param descriptor The descriptor to check.
     * @return {@code true} if legacy oneof case enum is enabled, {@code false} otherwise.
     */
     ...
     *
     * @return An optional containing the fully qualified name of the custom interface, or empty if none.
     */
     ...
     *
     * @return The outer class name, or an empty string if none is defined.
     */
    ...
    /**
     * Configuration interface specific to generating code for a single message.
     */
