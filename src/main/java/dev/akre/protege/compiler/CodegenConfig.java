...
public interface CodegenConfig {
     ...
     *
     * @param descriptor the protobuf descriptor
     * @return true if oneof case enum generation is enabled
     */
     ...
     * @param currentScope the current scope (list of package/message names)
     ...
     *
     * @param protoTypeName the protobuf type name
     * @param currentScope the current scope (Cons list of package/message names)
     * @return the resolved JavaPoet TypeName
     */
     ...
     *
     * @param field the field descriptor (must be a map field)
     ...
     *
     * @return the FieldAccessorTable class name
     */
     ...
     *
     * @return a map from protobuf type name to Java class name
     */
    ...
    /**
     * A specialized configuration for message generation.
     */
