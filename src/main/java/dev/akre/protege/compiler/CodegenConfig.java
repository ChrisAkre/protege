...
public interface CodegenConfig {
     ...
     * @return The Protobuf descriptor.
     */
    <T> T descriptor();
     ...
     * @return List of annotation specs.
     */
     ...
     * @param descriptor The descriptor object.
     * @return True if oneof case enum is generated.
     */
     ...
     * @return Optional containing the interface name.
     */
     ...
     * @param field The field descriptor.
     * @return The map entry descriptor.
     */
    ...
    /** Configuration scope for a message. */
