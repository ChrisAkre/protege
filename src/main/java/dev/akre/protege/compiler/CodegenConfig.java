...
public interface CodegenConfig {
     ...
     *
     * @return The descriptor object (e.g., DescriptorProto, EnumDescriptorProto).
     ...
     *
     * @return A list of annotation specs for fields.
     */
     ...
     *
     * @return A list of annotation specs for the class.
     */
     ...
     *
     * @return A list of annotation specs for the interface.
     */
     ...
     *
     * @return A list of annotation specs for the builder.
     */
     ...
     *
     * @return The class name of the superclass.
     */
     ...
     *
     * @return A map from proto type names to JavaPoet ClassNames.
     */
    ...
    /**
     * A specialized configuration interface for message generation.
     */
