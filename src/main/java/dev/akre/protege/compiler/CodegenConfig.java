...
public interface CodegenConfig {
     ...
     *
     * @return The underlying CodegenMetadata object.
     */
     ...
     *
     * @param <T> The type of descriptor being returned.
     ...
     * @return True if deprecated annotation should be generated.
     */
     ...
     *
     * @return The proto package string.
     */
     ...
     *
     * @return The target Java package string.
     */
     ...
     *
     * @return A list of AnnotationSpecs for the field.
     */
     ...
     *
     * @return A list of AnnotationSpecs for the class.
     */
     ...
     *
     * @return A list of AnnotationSpecs for the interface.
     */
     ...
     *
     * @return The annotations to apply to the generated builder.
     */
     ...
     *
     * @param name The full name of the message descriptor.
     ...
     *
     * @param descriptor The descriptor to check.
     * @return True if oneof case generation is enabled.
     */
     ...
     *
     * @return The name of the custom Java interface.
     */
     ...
     *
     * @return The custom base class Name.
     */
     ...
     *
     * @param protoTypeName The proto type name.
     ...
     *
     * @param field The field descriptor.
     * @return True if it is a map field.
     */
     ...
     *
     * @return A map containing all type registrations.
     */
    ...
    /**
     * Configuration interface for message specific codegen.
     */
