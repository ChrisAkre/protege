...
public interface CodegenConfig {
     ...
     *
     * @return The {@link CodegenMetadata} instance.
     */
     ...
     * @return {@code true} if the deprecated annotation should be generated, {@code false} otherwise.
     */
     ...
     *
     * @return The proto package name, or an empty string if not defined.
     */
     ...
     *
     * @return A list of {@link AnnotationSpec} representing the field annotations.
     */
     ...
     *
     * @return A list of {@link AnnotationSpec} representing the class annotations.
     */
     ...
     *
     * @return A list of {@link AnnotationSpec} representing the interface annotations.
     */
     ...
     *
     * @return A list of {@link AnnotationSpec} representing the builder annotations.
     */
     ...
     * @return The {@link DescriptorProtos.DescriptorProto} for the message.
     */
     ...
     *
     * @param descriptor The descriptor to check.
     * @return {@code true} if enhanced oneof generation is enabled, {@code false} otherwise.
     */
     ...
     *
     * @param descriptor The descriptor to check.
     * @return {@code true} if the legacy Case enum should be generated, {@code false} otherwise.
     */
     ...
     *
     * @return An {@link Optional} containing the interface name, or empty if none.
     */
     ...
     *
     * @return The {@link ClassName} of the superclass.
     */
     ...
     * @return The resolved {@link TypeName}.
     */
     ...
     * @param currentScope The current scope as a list of strings.
     * @return The determined {@link TypeName} for the field.
     */
     ...
     * @return {@code true} if the field is a map field, {@code false} otherwise.
     */
     ...
     *
     * @param field The field descriptor.
     * @return The {@link DescriptorProtos.DescriptorProto} for the map entry.
     */
     ...
     *
     * @return The {@link ClassName} for the FieldAccessorTable.
     */
     ...
     *
     * @return A map of type names to their {@link ClassName}.
     */
    ...
    /**
     * Specialized configuration interface for message generation.
     */
