...
public interface CodegenConfig {
     ...
     * @return true if the deprecated annotation should be generated
     */
     ...
     *
     * @param descriptor the descriptor context
     ...
     *
     * @return an optional interface name
     */
     ...
     *
     * @return the outer class name, or empty string
     */
     ...
     *
     * @param protoTypeName the name of the protobuf type
     * @param currentScope the current scope as a list
     ...
     * @return the map entry message descriptor
     */
     ...
     *
     * @return the field accessor table class name
     */
