...
public class CodegenUtils {
    ...
    /**
     * Mapping from Protobuf FieldDescriptorProto.Type to JavaPoet TypeName.
     * <p>
     * This map covers standard primitive types and wrapper types like ByteString.
     * It does not include ENUM or MESSAGE types as those require dynamic resolution.
     */
     ...
     * @param protoPackage The package name to remove.
     ...
     * @param oneofIndex The index of the oneof group in the descriptor.
     * @return A CodeBlock containing the statements to clear the oneof fields.
     */
