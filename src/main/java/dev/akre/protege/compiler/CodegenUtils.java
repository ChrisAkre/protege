...
public class CodegenUtils {
    ...
    /**
     * Mapping from Protobuf field types to their corresponding JavaPoet {@link TypeName}.
     */
     ...
     *
     * @param typeName     The full type name (e.g., ".com.example.MyMessage").
     * @param protoPackage The package name to strip (e.g., "com.example").
     * @return The relativized type name, or the original name if the package does not match.
     */
     ...
     * @return A {@link CodeBlock} containing the field clearing logic.
     */
