...
public class CodegenUtils {
    ...
    /**
     * Mapping from Protobuf field types to JavaPoet {@link TypeName}s.
     */
     ...
     *
     * @param context    The message generation context.
     * @param oneofIndex The index of the oneof group.
     * @return A {@link CodeBlock} containing the clear logic.
     */
