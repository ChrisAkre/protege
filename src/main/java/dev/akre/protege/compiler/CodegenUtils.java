...
public class CodegenUtils {
    ...
    /**
     * Map from Protobuf primitive field types to their corresponding Java TypeName representations.
     */
     ...
     * @param protoPackage the package name to trim
     ...
     * @param oneofIndex the index of the oneof to clear
     * @return the generated CodeBlock to clear the oneof fields
     */
