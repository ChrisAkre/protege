...
public class CodegenUtils {
    ...
    /**
     * Map of Protobuf field types to their corresponding JavaPoet TypeNames.
     */
     ...
     * @param protoPackage The proto package name to remove.
     ...
     * @param oneofIndex The index of the oneof group.
     * @return The CodeBlock containing the clear logic.
     */
