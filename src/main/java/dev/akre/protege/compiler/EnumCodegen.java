 ...
 * @param scope        the current scope list
 * @param protoCodegen the parent proto codegen instance
 * @param config       the codegen metadata configuration
 */
public record EnumCodegen(
    ...
    /**
     * Returns the outer class name for the enum.
     *
    ...
    /**
     * Returns the array of parent names for this enum.
     *
