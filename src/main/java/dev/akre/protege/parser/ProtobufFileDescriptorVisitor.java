...
public class ProtobufFileDescriptorVisitor extends ProtobufBaseVisitor<Object> {
    ...
    /**
     * Generates a file descriptor by processing the file-level options and then recursively descending through the parse tree.
     * <p>
     * The {@code scope} field is updated as the graph is traversed to resolve the full name of each processed object.
     * Each visit operation returns a descriptor or a configuration record that is then merged into the final {@link FileDescriptorProto}.
     *
