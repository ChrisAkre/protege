...
public class ProtobufFileDescriptorVisitor extends ProtobufBaseVisitor<Object> {
    ...
    /**
     * Generates a file descriptor by reading the options present at the file level and recursively descending through all children.
     * <p>
     * The scope is updated as the graph is traversed and is used to determine the full name of the object being processed.
