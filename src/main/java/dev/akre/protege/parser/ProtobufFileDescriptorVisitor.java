 ...
 * <p>
 * This class is responsible for traversing the parse tree generated by ANTLR and constructing
 * the corresponding Google Protobuf {@link FileDescriptorProto}. It handles:
 * <ul>
 *     <li>Syntax and package declarations</li>
 *     <li>Imports (dependencies)</li>
 *     <li>Options (file, message, field, etc.)</li>
 *     <li>Message and Enum definitions</li>
 *     <li>Service and RPC definitions</li>
 * </ul>
 * <p>
 * This visitor is designed to be single-use per file.
 */
public class ProtobufFileDescriptorVisitor extends ProtobufBaseVisitor<Object> {
    ...
    /**
     * Parses a Protobuf file and returns a FileDescriptorProto.Builder.
     *
     * @param filename The name of the file being parsed (for error reporting).
     * @param ctx      The root context of the ANTLR parse tree.
     * @return A builder for the FileDescriptorProto.
     * @throws InvalidProtoException If the proto definition is invalid.
     */
    ...
    /**
     * Visits the root protocol buffer definition.
     *
     * @param ctx The parse tree context.
     * @return The FileDescriptorProto.Builder populated with the file's content.
     */
    @Override
    ...
    /**
     * Visits a message definition.
     * <p>
     * Recursively visits nested types, enums, fields, and options.
     *
     * @param ctx The message definition context.
     * @return The DescriptorProto.Builder for the message.
     */
    @Override
     ...
     * <p>
     * Map fields are synthesized as a repeated message field of an auto-generated Entry message
     * containing key and value fields.
     *
     * @param ctx The map field context.
     * @return A Record containing the synthetic field and the synthetic entry message.
     */
    @Override
    ...
    /**
     * Visits a oneof definition.
     *
     * @param ctx The oneof context.
     * @return A Record containing the OneofDescriptor and its associated fields.
     */
    @Override
    ...
    /**
     * Visits a standard field definition.
     *
     * @param ctx The field context.
     * @return The FieldDescriptorProto.Builder.
     */
    @Override
     ...
     *
     * @param ctx The enum definition context.
     * @return The EnumDescriptorProto.Builder.
     */
    @Override
    ...
    /**
     * Visits a service definition.
     *
     * @param ctx The service definition context.
     * @return The ServiceDescriptorProto.Builder.
     */
    @Override
    ...
    /**
     * Visits an RPC definition within a service.
     *
     * @param rpcCtx The RPC context.
     * @return The MethodDescriptorProto.Builder.
     */
    @Override
