...
public class ProtobufFileDescriptorVisitor extends ProtobufBaseVisitor<Object> {
    ...
    /**
     * Generates a file descriptor by first processing file-level options and then recursively descending through all children.
     * <p>
     * The {@code scope} is updated as the graph is traversed to determine the fully qualified name of each object.
     * Each visit operation returns a descriptor or a record that is subsequently merged into the main file descriptor.
     *
     * @param ctx The parse tree context for the proto file.
