...
public class ProtobufFileDescriptorVisitor extends ProtobufBaseVisitor<Object> {
    ...
    /**
     * Generates a file descriptor by first reading the file-level options, and then recursively
     * descending through all children.
     * <p>
     ...
     * @return the builder for the file descriptor
     */
    @Override
