...
public class ProtobufFileDescriptorVisitor extends ProtobufBaseVisitor<Object> {
    ...
    /**
     * Generates a file descriptor by visiting the parse tree.
     * <p>
     * This method first reads the options present at the file level, and then recursively descends through all children.
     * <p>
     * The internal {@code scope} is updated as the graph is traversed and is used to determine the full name of the
     * object being processed. Each visit operation returns a descriptor or a record that is merged into the file descriptor.
     *
     * @param ctx the proto parse tree context
