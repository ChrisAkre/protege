 ...
 * @param head the element at the head of the list
...
public record Cons<T>(T head, Cons<T> tail) implements UnmodifiableCons<T> {
     ...
     * @return a new cons list with the prepended element
     */
    ...
    /**
     * Creates a cons list from the given elements.
     * @param <T> element type
     * @param elements the elements
     * @return a new cons list containing the given elements
     */
    @SafeVarargs
