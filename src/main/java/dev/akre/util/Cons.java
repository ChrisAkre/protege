...
public record Cons<T>(T head, Cons<T> tail) implements UnmodifiableCons<T> {
    ...
    /**
     * Compact constructor that validates the cons cell.
     * <p>
     * Note: This constructor is generally not called directly by users; use {@link #cons(Object)},
     * {@link #of(Object[])}, or {@link #nil()} instead.
     *
     * @param head the element at this node (must be non-null unless this is NIL)
     * @param tail the rest of the list (must be non-null unless this is NIL)
     */
    public Cons {
     ...
     * @return the singleton empty list instance
     */
     ...
     * @return a new Cons cell with {@code t} as the head and this list as the tail
     */
     ...
     *
     * @param values the iterable source of elements
     * @param <T> the type of elements
     * @return a new list containing the elements from the source
     */
     ...
     *
     * @return a sequential Stream of the elements in this list, starting from the head
     */
