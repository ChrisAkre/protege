...
public record Cons<T>(T head, Cons<T> tail) implements UnmodifiableCons<T> {
     ...
     * <p>
     * Internal validation ensures that nulls are only permitted for the NIL sentinel instance.
     *
     * @param head The value at the head of the list.
     * @param tail The rest of the list.
     * @throws IllegalArgumentException if a non-NIL instance is created with null components.
     */
    public Cons {
     ...
     * @return The singleton NIL instance.
     */
     ...
     * @return A new Cons cell with 't' as the head and this list as the tail.
     */
     ...
     * @return A new Cons list containing the provided elements.
     */
    @SafeVarargs
     ...
     *
     * @param values The iterable collection of values to copy.
     * @param <T> The type of elements.
     * @return A new Cons list containing the elements from the iterable.
     */
     ...
     *
     * @return A sequential stream over the elements in this list.
     */
